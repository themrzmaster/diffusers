...
def parse_args(input_args=None):
    ...
    parser.add_argument(
        "--train_text_encoder",
        action="store_true",
        help="Whether to train spectral shifts in the text encoder. If set, the text encoder should be float32 precision.",
    )
    parser.add_argument(
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            with accelerator.accumulate(unet):
                ...
                if args.with_prior_preservation:
                    ...
                    noise_pred, noise_pred_prior = torch.chunk(model_pred, 2, dim=0)
            ...
            if accelerator.sync_gradients:
                ...
                if accelerator.is_main_process:
                    if global_step % args.checkpointing_steps == 0:
                        ...
                        # TODO: support accelerator saving
